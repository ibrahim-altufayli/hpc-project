...
int main(int argc, char **argv)
{
    ...
    if(!results_out.is_open()){
            results_out.open("builds/time_results_dynamic.txt", ios::trunc);
    }
    ...
    imgFilePath.append(to_string(RESOLUTION)+"_"+to_string(ITERATIONS)+"_"+to_string(nThreads)+"_dynamic");
